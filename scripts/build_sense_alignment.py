...
def write_report(stats: dict, fail_counts: Counter, shape_counts: Counter,
    ...
    lines += [
        ...
        "",
        "## How wrong the surviving rows are (H5070)",
        "",
        "This report describes what the aligner DID; it carries no error rate. The measured",
        "error-versus-coverage curve over this population, its abstention split and its",
        "controls live beside the table in",
        "[selective_risk/SELECTIVE_RISK_REPORT.md]"
        "(https://github.com/gasyoun/kosha/blob/main/data/concordance/selective_risk/SELECTIVE_RISK_REPORT.md),",
        "regenerated by `scripts/score_sense_alignment_selective_risk.py`. Two results there",
        "bear directly on this page: limit 7 above was independently re-derived (every",
        "ŚKDR-bearing card in that deck is a wrong match of exactly that shape), and an",
