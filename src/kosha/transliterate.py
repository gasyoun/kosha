...
# Declared, pinned dependency since W0B (H1944) — see the note in kosha/render.py
# about the sibling-checkout `sys.path` insert W0C removed.
from sanskrit_util import to_slp1, from_slp1, deva_to_slp1, iast_to_devanagari
