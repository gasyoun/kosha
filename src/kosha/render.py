...
# `sanskrit-util` is a declared, pinned dependency since W0B (H1944), so this is
# a plain import — the `sys.path` insert into a sibling checkout that stood here
# before W0C moved this module into the package is gone with it.
