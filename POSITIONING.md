...
| **sanskritdictionary.com, Wisdom Library, learnsanskrit.org** | Aggregators; fast but provenance-thin | kosha's differentiator against all of them is **print-truth**: every entry linked to the scanned page, every datum carrying its source + version |
