# kosha OxAlpha code-review implementation

_Created: 26-08-2026 · Last updated: 26-08-2026_

1. Start from fresh origin/main; read [agent instructions](https://github.com/gasyoun/kosha/blob/main/CLAUDE.md), state, README, changelog, CI, and relevant plans.
2. Add canonical files under [docs/agents](https://github.com/gasyoun/kosha/blob/main/docs/agents), update the existing instruction file, keep PR intake OFF, create only missing labels, and merge separately.
3. Validate and rank #252, #342, #257, #254, #256, #375, #393, #364, #431, #245; replace out-of-window or non-executable candidates without exceeding ten.
4. Fetch PR body, issues, files, commits, base SHA, and head SHA; resolve spec evidence in the ruled order.
