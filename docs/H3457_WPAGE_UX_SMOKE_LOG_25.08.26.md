# H3457 word-page UX staging — Playwright smoke log (variant `a`)

_Created: 25-08-2026 · Last updated: 25-08-2026_

_Run 25-08-2026 08:31 local · Chromium headless via Python Playwright · file:// over `dist/w-staging/a/` · 11 pages × 2 viewports · 12.2 s · verdict **PASS**_
...
Reproduce: `python scripts/build_word_pages.py --ux-staging a --tokens agni,as,Darma,deva,gam,jana,kf,nf,rAma,vac,yA` then `python scripts/smoke_wpage_ux.py --variant a`.
