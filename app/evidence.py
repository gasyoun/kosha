...
[`src/kosha/evidence.py`](https://github.com/gasyoun/kosha/blob/main/src/kosha/evidence.py)
so `kosha.api.serializer` can import it without a `sys.path` insert. The
bare-name import (`from evidence import …`) that `app/` and `scripts/` have used
since Phase 1 keeps working through this re-export; new code should import
`kosha.evidence` directly.
"""

from kosha.evidence import *  # noqa: F401,F403
