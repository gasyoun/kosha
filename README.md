...
_Created: 02-07-2026 · Last updated: 10-09-2026_
...
— currently <!-- dataset_count_start -->**124 datasets** (106 public · 15 restricted · 3 intermediate)<!-- dataset_count_end --> — the
...
| [SANDHI_PROGRAMME.md](https://github.com/gasyoun/kosha/blob/main/SANDHI_PROGRAMME.md) | **the sandhi programme hub** — what exists & how to use it: inducer (96.3 % gold), 17-text corpus, A/B/C splitter bake-off (method C ≫ B), teaching surfaces, datasets, scripts, rebuild steps, cross-repo consumers |
